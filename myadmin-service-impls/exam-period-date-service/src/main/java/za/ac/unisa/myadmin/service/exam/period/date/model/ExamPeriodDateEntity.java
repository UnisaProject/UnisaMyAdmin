...
@Entity
@Table(name = "XAMDAT")
public class ExamPeriodDateEntity {

	@EmbeddedId
	private ExamPeriodDateIdentity examPeriodDateIdentity;
	...
	public ExamPeriodDateEntity() {
	}

	public ExamPeriodDateEntity(ExamPeriodDateInfo dto) {
		this.examPeriodDateIdentity = new ExamPeriodDateIdentity(dto.getYear(), dto.getExamPeriodCode(),
				dto.getCourseCode(), dto.getPaperNumber());
		this.fromDto(dto);
	}

	public void fromDto(ExamPeriodDateInfo dto) {
	...
	public ExamPeriodDateInfo toDto() {
		ExamPeriodDateInfo info = new ExamPeriodDateInfo();
	...
	public ExamPeriodDateIdentity getExamPeriodDateIdentity() {
		return examPeriodDateIdentity;
	}

	public void setExamPeriodDateIdentity(ExamPeriodDateIdentity examPeriodDateIdentity) {
		this.examPeriodDateIdentity = examPeriodDateIdentity;
	}
