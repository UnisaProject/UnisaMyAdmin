 ...
 */
public class StudyMaterialWebServiceimpl {

	private static Log logger = LogFactory.getLog(StudyMaterialWebServiceimpl.class);
...
//	}
	...
	private boolean isDateBeforeSysDate(Date dateStr) {// yyyy-mm-dd
		Date today = today();
	...
	private boolean isAvailableDateValid(Date dateAvailable) {
...
//	}
	...
	private String getModule(String itemShortDesdc) {
