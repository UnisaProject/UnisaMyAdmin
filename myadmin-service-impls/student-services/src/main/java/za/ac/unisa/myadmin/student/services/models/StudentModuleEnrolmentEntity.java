...
@Entity
@Table(name = "STUSUN")
//@NamedQuery(name="StudentModuleEnrolment.findAll", query="SELECT s FROM StudentModuleEnrolmentEntity s")
public class StudentModuleEnrolmentEntity implements Serializable {

	private static final long serialVersionUID = 1L;

	@EmbeddedId
	StudentModuleEnrolmentEntityId studentModuleEnrolmentEntityId;
	...
	public StudentModuleEnrolmentEntity() {
	}

	public StudentModuleEnrolmentInfo toDto() {
		StudentModuleEnrolmentInfo info = new StudentModuleEnrolmentInfo();
	...
	public StudentModuleEnrolmentEntityId getStudentModuleEnrolmentEntityId() {
		return studentModuleEnrolmentEntityId;
	}

	public void setStudentModuleEnrolmentEntityId(StudentModuleEnrolmentEntityId studentModuleEnrolmentEntityId) {
		this.studentModuleEnrolmentEntityId = studentModuleEnrolmentEntityId;
	}
}