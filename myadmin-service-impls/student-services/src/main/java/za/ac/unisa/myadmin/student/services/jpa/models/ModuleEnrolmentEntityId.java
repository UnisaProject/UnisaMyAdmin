...
@Embeddable
public class ModuleEnrolmentEntityId implements Serializable {
	...
	public ModuleEnrolmentEntityId() {
	}

	public ModuleEnrolmentEntityId(Integer academicYear, Integer academicPeriod, String studyUnitCode, Integer studentNumber, Integer semesterPeriod) {
