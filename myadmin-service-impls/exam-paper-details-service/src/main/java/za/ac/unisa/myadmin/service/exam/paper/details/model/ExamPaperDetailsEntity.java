...
@Entity
@Table(name = "XAMPAP")
public class ExamPaperDetailsEntity {

	@EmbeddedId
	private ExamPaperDetailsIdentity examPaperDetailsIdentity;
	...
	public ExamPaperDetailsEntity() {
	}

	public ExamPaperDetailsEntity(ExamPaperDetailsInfo dto) {
		this.examPaperDetailsIdentity = new ExamPaperDetailsIdentity(dto.getYear(), dto.getCourseCode());
		this.fromDto(dto);
	}

	public void fromDto(ExamPaperDetailsInfo dto) {
	...
	public ExamPaperDetailsInfo toDto() {
		ExamPaperDetailsInfo info = new ExamPaperDetailsInfo();
	...
	public ExamPaperDetailsIdentity getExamPaperDetailsIdentity() {
		return examPaperDetailsIdentity;
	}

	public void setExamPaperDetailsIdentity(ExamPaperDetailsIdentity examPaperDetailsIdentity) {
		this.examPaperDetailsIdentity = examPaperDetailsIdentity;
	}
